...
- **`<em>`**: Represents emphasized text. Browsers display this as _italicized_ text by default. Use this for stress or vocal emphasis on a word.
...
```html
<p>
  This is a paragraph with <strong>very important</strong> information and a
  word with <em>emphasis</em>.
</p>
...
<img
  src="sunset.jpg"
  alt="A beautiful red sunset over the ocean"
  style="width: 400px;"
/>
<a href="https://www.newsite.com" id="external-link" class="link-style"
  >Visit New Site</a
>
```
...
### **Lesson: HTML Entities (Special Characters)**

**Explanation:**
Some characters are reserved in HTML (like `<` and `>`) because the browser interprets them as tags. To display these characters, or other special symbols (like © or €), you must use **HTML entities**.

- Format: `&entity_name;` or `&#entity_number;`
...
```html
<p>To write a paragraph tag, you use &lt;p&gt; and &lt;/p&gt;.</p>
...
**Explanation:**
Comments are used to leave notes in your code for yourself or other developers. They are **not visible** in the browser.
...
- To temporarily "hide" code during testing (commenting it out).
- To organize large HTML files into sections.
...
<!-- <p>This paragraph is hidden and won't show up!</p> -->
```
